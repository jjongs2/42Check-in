  ...
  return (
    <Link
      ...
      className={cls(
        ...
        'rounded-[20px] border-2 px-1 py-3.5 text-center text-sm font-bold text-white transition transition-[bg-color] hover:border-[#6AA6FF] hover:bg-[#6AA6FF] dark:border-slate-800 dark:hover:bg-white',
      )}
    >
      {text}
    </Link>
