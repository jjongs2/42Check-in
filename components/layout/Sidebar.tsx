  ...
  return (
    <Link
      ...
      className={cls(
        ...
        'rounded-[20px] border-2 px-1 py-3.5 text-center text-sm font-bold text-white transition dark:border-slate-800 dark:bg-slate-800 hover:border-[#6AA6FF] hover:bg-[#6AA6FF] dark:hover:bg-white',
      )}
    >
      {text}
    </Link>
